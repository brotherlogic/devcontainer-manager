...
and if it detects that the devcontainer configuration has changed, it will delete and recreate the new container with the updated configuration, without automatically starting an IDE.
