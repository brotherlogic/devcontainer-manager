...
## Supported Projects
Adding support for `brotherlogic/recordcollection`, `brotherlogic/sale-description-generator`, `brotherlogic/recordalerting`, `brotherlogic/focus`, and `brotherlogic/seraphine` and their specific environment needs.
