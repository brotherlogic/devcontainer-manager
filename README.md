...
## Supported Projects
Adding support for `brotherlogic/dcrouter`, `brotherlogic/focus`, `brotherlogic/gramophile`, `brotherlogic/recordalerting`, `brotherlogic/recordcollection`, `brotherlogic/recordgetter`, `brotherlogic/sale-description-generator`, `brotherlogic/prod` and `brotherlogic/seraphine` and their specific environment needs.
...
The manager automatically allocates a unique SSH port for each devcontainer (starting from 2222) and maps it to the container's SSH port (22) using `--docker-run-args`. 
