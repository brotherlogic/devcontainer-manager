...
## Supported Projects
Adding support for `brotherlogic/recordcollection`, `brotherlogic/sale-description-generator`, `brotherlogic/recordalerting`, `brotherlogic/focus`, `brotherlogic/seraphine`, and `brotherlogic/gramophile` and their specific environment needs.
